...
import { AdvancedReportsClient } from "./advanced-reports-client";
import Link from "next/link";

export default async function AdvancedClinicalReportsPage() {
    ...
    <div className="min-h-screen bg-background md:flex">
      ...
      <main className="min-w-0 flex-1 pb-22 md:pb-0">
        ...
        <div className="mx-auto max-w-7xl p-5 sm:p-8">
          ...
          <AdvancedReportsClient state={state} userName={session.name} />
        </div>
      </main>
    </div>
  );
